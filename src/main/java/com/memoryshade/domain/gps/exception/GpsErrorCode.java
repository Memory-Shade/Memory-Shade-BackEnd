...
public enum GpsErrorCode implements ErrorCode {
    ...
    USER_ONLY(HttpStatus.FORBIDDEN, "사용자만 안전 지역을 조회할 수 있습니다"),
    ...
    SELF_READ_ONLY(HttpStatus.FORBIDDEN, "본인의 안전 지역만 조회할 수 있습니다"),
    GPS_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 안전 지역을 찾을 수 없습니다");
